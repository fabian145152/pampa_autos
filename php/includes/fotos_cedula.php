...
if (
    isset($_FILES['cedula_f'])
    && isset($_FILES['cedula_d'])
) {
    $archivo1 = $_FILES['cedula_f'];
    $archivo2 = $_FILES['cedula_d'];
    ...
    if (
        ...
        echo $cedula_f= $directorio . basename($archivo1['name']);
        //echo "<br>";
        //echo "Ruta de la foto del auto atras: ";  
        echo $cedula_d = $directorio . basename($archivo2['name']);
        //echo "<br>";

        if (
            move_uploaded_file($archivo1['tmp_name'], $cedula_f)
            && move_uploaded_file($archivo2['tmp_name'], $cedula_d)
        ) {
